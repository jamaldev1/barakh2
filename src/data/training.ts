...
export const trainingSessionsData: TrainingSession[] = [
  {
    ...
    venue: 'Al Barakah Main Facility (200+ Beds Setup)',
  ...
  },
  {
    ...
    venue: 'Al Barakah Hyderabad Regional Center',
    format: 'Practical Workshop',
    duration: 'Half Day Session',
    price: 'Open for Farmers, Nurseries & Students',
    seatsTotal: 30,
    seatsLeft: 9,
    instructor: 'Al Barakah Technical Agronomy Team',
  ...
  },
  {
    ...
    seatsTotal: 100,
    seatsLeft: 50,
    instructor: 'Al Barakah Master Trainers & Specialists',
